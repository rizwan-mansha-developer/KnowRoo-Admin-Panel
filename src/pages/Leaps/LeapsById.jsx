...
const LeapsBySchool = () => {
  ...
  }, [addStatus, leapsError, dispatch, schoolId]);
  ...
  }, [deleteStatus, deleteError, dispatch, schoolId]);
  ...
  const renderLeapsCards = () => (
    <div style={{ display: 'flex', gap: '20px', flexWrap: 'wrap' }}>
      ...
      ) : leapsBySchool?.notFound || leapsBySchool?.length <= 0 ? (
        <div
          style={{
            display: 'flex',
  ...
  return (
    <AdminLayout>
      ...
      >
        ...
        />
        <Grid>{renderLeapsCards()}</Grid>
      </div>
      <ModalOpen
        AddContent={<AddLeaps CloseModal={handleModalClose} />}
...
LeapsBySchool.propTypes = {
  data: PropTypes.string,
};

export default LeapsBySchool;
