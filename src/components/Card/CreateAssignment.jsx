...
import AssignmentIcon from '../../assets/CardsIcon/assignmentIcon.svg';
import UnSelectIcon from '../../assets/CardsIcon/unSelectIcon.svg';
...
const CreateAssignment = ({ id, count, heading, color, isHovered }) => {
  ...
  const handleCardClick = () => {
    ...
    sessionStorage.setItem('assignmentName', heading);
    // navigate('/mobs/adventures/leaps/hops/startHops'  ,  { state: { id , Name } });
    navigate('/mobs/adventures/leaps/hops/startHops/assignment', { state: { id, heading } });
  };

  return (
    <>
      <StyledCard onClick={handleCardClick} style={{ background: isHovered ? '#fff' : '#E2F3FF' }}>
          ...
          <CardContent>
            <Box display="flex" justifyContent="space-between">
              ...
              <Box>
                ...
                <img style={{ width: '70px' }} src={isHovered ? AssignmentIcon : UnSelectIcon} />
              </Box>
            </Box>
          </CardContent>

          {/* <Box>
          <img style={{ marginTop: '-10px', marginLeft: '20px' }} src={TimerIcon} />
          <Typography style={{ color: '#616161', fontSize: '14px', fontWeight: 'bold' }}>
            65 Min
          </Typography>
        </Box> */}
        </Box>
